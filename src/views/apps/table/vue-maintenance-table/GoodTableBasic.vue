...
import {
  BAvatar, BBadge, BPagination, BButton, BFormGroup, BFormInput, BFormSelect, BDropdown, BDropdownItem,
} from 'bootstrap-vue'
...
export default {
  ...
  created() {
    this.$http.get('http://3.143.116.184:8082/sgpmes/maintenance/list')
